  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="bg-white border border-zinc-100 shadow-[0_20px_50px_rgba(0,0,0,0.08)] p-8">
            {/* Kapatma Butonu */}
            <button
            ...
            <div className="space-y-6">
              ...
              <p className="text-[12px] text-zinc-600 leading-relaxed font-light">
                ...
                <Link
                  ...
                  className="text-zinc-900 underline underline-offset-4 ml-1 hover:text-zinc-500 transition-colors"
                >
                  Politikayı İncele
                </Link>
              </p>
              ...
              <div className="flex flex-col gap-3 pt-2">
                <button
                  ...
                  className="w-full h-11 bg-zinc-900 text-white text-[10px] tracking-[0.2em] uppercase transition-all hover:bg-zinc-800 active:scale-[0.98]"
                >
                  Kabul Ediyorum
                </button>
                <button
