        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <form onSubmit={handleSubmit} className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              <div className="p-6 border-b border-slate-50 bg-slate-50/50">
                <h3 className="text-sm font-semibold text-slate-800 flex items-center gap-2">
                  <Zap className="w-4 h-4 text-orange-500" /> Temel Yapılandırma
                </h3>
              </div>
              ...
              <div className="p-8 grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all uppercase font-mono font-bold"
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 p-1 bg-slate-100 rounded-xl">
                    ...
                    >
                      <Percent className="w-3 h-3" /> Yüzdelik
                    </button>
                    <button
                      type="button"
                      onClick={() =>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              <div className="p-6 border-b border-slate-50 bg-slate-50/50">
                <h3 className="text-sm font-semibold text-slate-800 flex items-center gap-2">
                  <ShieldCheck className="w-4 h-4 text-indigo-500" /> Kullanım
                  Kısıtlamaları
                </h3>
              </div>
              <div className="p-8 grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all"
            ...
            <button
              disabled={loading}
              className="group w-full bg-slate-900 text-white py-4 rounded-2xl text-sm font-semibold uppercase tracking-widest hover:bg-indigo-600 transition-all shadow-xl shadow-slate-200 flex items-center justify-center gap-2 disabled:bg-slate-300"
            >
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-gradient-to-br from-indigo-600 to-indigo-800 p-6 rounded-3xl shadow-2xl shadow-indigo-200 overflow-hidden text-white group">
              ...
              <div className="relative">
                <div className="bg-white/20 w-fit px-3 py-1 rounded-full text-[10px] font-bold tracking-tighter mb-4">
                  {formData.type === "PERCENTAGE"
                    ? "YÜZDELİK İNDİRİM"
                    : "NAKİT İNDİRİM"}
                </div>
                <div className="text-3xl font-black mb-1 leading-none tracking-tight">
                  {formData.value
                    ? formData.type === "PERCENTAGE"
                      ? `%${formData.value}`
                      : `${formData.value} TL`
                ...
                <div className="text-white/60 text-xs font-light italic mb-6">
                  {formData.minAmount
                ...
                <div className="flex items-center justify-between bg-black/20 p-3 rounded-2xl border border-white/10">
                  ...
                  <button
                    type="button"
                    className="text-[10px] uppercase font-bold text-indigo-200"
                  >
                    Kopyala
                  </button>
                </div>
            ...
            <div className="bg-orange-50 p-4 rounded-2xl border border-orange-100">
              <p className="text-[11px] text-orange-700 leading-relaxed font-medium italic">
