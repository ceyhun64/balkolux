          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 w-full md:w-64 bg-white border-slate-200 rounded-xl shadow-sm focus:ring-4 focus:ring-blue-50 transition-all"
              />
            </div>
          </div>
        </header>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center">
                  <Mail className="w-5 h-5 text-[#001e59]" />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    ...
                    className="bg-slate-50 border-none rounded-xl min-h-[180px] py-3 resize-none"
                  />
                </div>
                ...
                <Button
                  ...
                  disabled={sending}
                  className="w-full bg-[#001e59] hover:bg-[#003080] text-white rounded-xl h-12 font-semibold shadow-lg shadow-blue-900/10 transition-all flex items-center gap-2"
                >
                  {sending ? (
            ...
            <div className="flex items-center justify-between px-2">
              ...
              {selectedIds.length > 0 && (
                <Button
                  ...
                  className="h-8 rounded-lg text-xs gap-2 px-3 animate-in fade-in slide-in-from-right-2"
                >
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {paginatedUsers.map((user) => (
                  <div
                    key={user.id}
                    className={`group p-4 bg-white rounded-2xl border transition-all flex items-center justify-between hover:shadow-md hover:border-blue-200 ${
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="opacity-0 group-hover:opacity-100 h-8 w-8 text-slate-300 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all"
                    >
