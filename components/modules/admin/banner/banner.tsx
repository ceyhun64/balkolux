...
const BannerPreviewCard = ({
  ...
  <div className="relative w-full h-[240px] rounded-2xl overflow-hidden bg-[#0f0f0f] border border-stone-800 group-hover:border-stone-600 transition-all duration-500">
    {/* Arka Plan Efekti */}
    <div className="absolute inset-0 opacity-20 bg-[url('https://www.transparenttextures.com/patterns/asfalt-dark.png')]" />
    <div className="absolute -top-[20%] -right-[10%] w-[60%] h-[120%] bg-stone-400/10 rounded-full blur-[80px]" />

    <div className="relative h-full flex flex-col items-center justify-center text-center p-6">
      <span className="text-[7px] tracking-[0.4em] text-stone-500 uppercase mb-3 block font-medium">
        Önizleme Modu
      </span>
      ...
      <p className="text-stone-400 text-[10px] font-light max-w-[240px] leading-relaxed line-clamp-2">
        {subtitle || "Açıklama metni burada görünecek."}
      </p>

      <div className="mt-5 px-4 py-2 border border-stone-800 text-[8px] tracking-[0.2em] text-stone-400 uppercase">
        Detayları İncele
      </div>
    </div>
  </div>
