  ...
  return (
    <div className="min-h-screen bg-[#FCFBFA] text-stone-800 selection:bg-stone-100">
      ...
      <header className="relative h-[70dvh] w-full flex flex-col items-center justify-center text-center px-6">
        ...
        >
          <div className="space-y-4">
            ...
            <h1 className="text-4xl md:text-7xl font-serif font-light tracking-tight leading-[1.1] text-stone-900">
              {blog.title}
            </h1>
          </div>
        </motion.div>
      ...
      <article className="max-w-2xl mx-auto px-6 pb-32">
        ...
        {/* FOOTER */}
        <div className="mt-24 pt-12 border-t border-stone-100 flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
          <div className="flex flex-col gap-2">
            <span className="text-[10px] uppercase tracking-widest text-stone-400 font-bold">
              Yayıncı
            </span>
            <span className="text-sm font-serif italic text-stone-900">
              BalkoLüx Tasarım Atölyesi
            </span>
          </div>
          <Link
            href="/blog"
            className="group flex items-center gap-2 text-xs tracking-widest uppercase font-bold text-stone-900"
          >
            Tüm Yazıları Gör{" "}
