...
export default function SeatingSets() {
  ...
  return (
    // Arka plan rengi stone-50 ve yazı tipi stone-900 olarak güncellendi
      ...
      <main className="container mx-auto px-6 md:px-12 py-24 lg:py-24 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-8 border-b border-stone-200 pb-8">
          <button
            ...
            className="group flex items-center gap-3 modern-sans text-[11px] tracking-[0.2em] uppercase text-stone-500 hover:text-black transition-all"
          >
            <div
              className={cn(
