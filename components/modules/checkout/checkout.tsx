...
export default function PaymentPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] py-12 md:py-20 font-sans text-zinc-950">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-10">
            ...
            <Link
              href="/contact"
              className="group block p-6 bg-zinc-950 rounded-[2rem] text-white transition-transform hover:scale-[1.02] active:scale-95"
            >
        ...
        <div className="fixed inset-0 bg-white/80 backdrop-blur-xl flex items-center justify-center z-[100] animate-in fade-in duration-500">
          <div className="text-center space-y-8 max-w-xs">
            <div className="relative w-24 h-24 mx-auto">
              <div className="absolute inset-0 border-t-4 border-zinc-950 rounded-full animate-spin"></div>
              <div className="absolute inset-4 bg-zinc-100 rounded-full flex items-center justify-center">
