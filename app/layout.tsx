...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://balkolux.com/og-image.ico",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://balkolux.com/og-image.ico"],
  },
...
export default function RootLayout({
  ...
  const storeJsonLd = {
    ...
    url: "https://balkolux.com",
    logo: "https://balkolux.com/logo/og-image.ico",
    image: "https://balkolux.com/og-image.ico",
